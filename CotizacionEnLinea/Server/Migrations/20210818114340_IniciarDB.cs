        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Apellido1 = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    Apellido2 = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    RazonSocial = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    NombreEmpresa = table.Column<string>(type: "nvarchar(100)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cotizacion_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cotizacion_Licitacion_IdLicitacion",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LinsxLicit_Licitacion_IdLicitacion",
                        column: x => x.IdLicitacion,
                        principalTable: "Licitacion",
                        principalColumn: "IdLicitacion",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Precio = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    IdLicitacion = table.Column<int>(type: "int", nullable: false),
                    LineaLicitacionId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LinsxCotiz_LinsxLicit_LineaLicitacionId",
                        column: x => x.LineaLicitacionId,
                        principalTable: "LinsxLicit",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cotizacion_IdLicitacion",
                table: "Cotizacion",
                column: "IdLicitacion");

            migrationBuilder.CreateIndex(
                name: "IX_Cotizacion_UserId",
                table: "Cotizacion",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LinsxCotiz_LineaLicitacionId",
                table: "LinsxCotiz",
                column: "LineaLicitacionId");

            migrationBuilder.CreateIndex(
                name: "IX_LinsxLicit_IdLicitacion",
                table: "LinsxLicit",
                column: "IdLicitacion");
